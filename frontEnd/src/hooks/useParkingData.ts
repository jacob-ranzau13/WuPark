...
export const ALL_LOT_LOCATIONS: Record<number, { lat: number; lng: number; name: string }> = {
  ...
  7: { lat: 37.720604467178106, lng: -97.28832845317815, name: 'Lot 4' },
  8: { lat: 37.72234843217308, lng: -97.28694979778821, name: 'Lot 19E' },
  9: { lat: 37.722513915768545, lng: -97.28550676934118, name: 'Lot 21N' },
  10: { lat: 37.71620830509887, lng: -97.28593055829677, name: 'Lot 35S' },
  11: { lat: 37.72198776152478, lng: -97.28966816149227, name: 'Lot 19W' },
  12: { lat: 37.723306114058516, lng: -97.29417427266837, name: 'University UMC Lot' },
  13: { lat: 37.7151588774984, lng: -97.29696913445667, name: 'Lot 25' },
  14: { lat: 37.7151588774984, lng: -97.29591770857098, name: 'Lot 24' },
  15: { lat: 37.721498523284616, lng: -97.29860667812783, name: 'Lot 2W' },
  16: { lat: 37.722563564500774, lng: -97.2973982879194, name: 'Lot 2N' },
  17: { lat: 37.72240020260324, lng: -97.29645146818052, name: 'Lot 2E' },
  18: { lat: 37.724046534618914, lng: -97.30085833749285, name: 'Lot 22' }
};

export const ALL_LOT_IDS = Object.keys(ALL_LOT_LOCATIONS).map(Number);
